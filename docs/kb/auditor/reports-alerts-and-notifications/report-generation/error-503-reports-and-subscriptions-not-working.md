...
- Review Web Service and Web Portal URLs — refer to the following article for additional information: [Deploying the Report Server Database](/docs/kb/auditor/system-administration/database-management/deploying-the-report-server-database.md)
...
- [Error: Service Did Not Respond to Start or Control Request in SSRS](/docs/kb/auditor/troubleshooting-and-errors/data-collection-errors/error-service-did-not-respond-to-start-or-control-request-in-ssrs.md)
