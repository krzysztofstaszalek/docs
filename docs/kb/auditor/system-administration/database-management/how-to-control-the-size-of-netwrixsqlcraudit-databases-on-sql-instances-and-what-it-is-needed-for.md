...
For additional information about how Netwrix Auditor for SQL Server works, please refer to the following KB: [How Netwrix Auditor for SQL Server Collects Data](/docs/kb/auditor/configuration-and-setup/sql-server-auditing/how-netwrix-auditor-for-sql-server-collects-data.md)
